...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-irony popup-kill-ring exwm symon dmenu diminish spaceline company dashboard switch-window rainbow-mode avy smex ido-vertical-mode beacon spacemacs-theme which-key use-package))))
(custom-set-faces
